...
const sidebars = {
  ...
  webSidebar: [
...

    {
      ...
      items: [
        { type: 'doc', id: 'docs/metrics-models/productivity/README' },
        { type: 'doc', id: 'docs/metrics-models/robustness/README' },
        { type: 'doc', id: 'docs/metrics-models/niche-creation/README' },
      ],
    },

    {
      type: 'category',
      collapsed: false,
      label: 'Productivity Metrics Models',
      link: {
        type: 'generated-index',
...

    {
      type: 'category',
      collapsed: false,
      label: 'Robustness Metrics Models',
      link: {
        type: 'generated-index',
...

    {
      type: 'category',
      collapsed: false,
      label: 'Niche Creation Metrics Models',
      link: {
        type: 'generated-index',
